...
def test_post_task():
    reseed()
    post_response = client.post("/thor-admin/tasks", json = dummy_post_test)
...
def test_post_task_bad():
    ...
    client.put("/thor-admin/clear")
    post_response = client.post("/thor-admin/tasks", headers={"Content-Type": "application/json"}, \
        data = "not-a-json")
    ...
    post_response = client.post("/thor-admin/tasks", json = \
